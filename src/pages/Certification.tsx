...
const Certification = () => {
  ...
  return (
    <div className="pt-16 bg-[#15171C] min-h-screen">
      ...
      {/* Navigation Tabs */}
      <section className="bg-[#15171C] shadow-lg sticky top-20 z-40">
              ...
              <button
                ...
                className={`flex items-center px-6 py-4 border-b-2 transition-all duration-200 ${
                  activeTab === tab.id
                    ...
                    : 'border-transparent text-gray-300 hover:text-primary-green hover:border-primary-green/50'
                }`}
              >
      ...
      {/* Content Sections */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-[#15171C]">
        
        {/* Overview Tab */}
        {activeTab === 'overview' && (
          <div className="space-y-16">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Why Choose HFZ Certification?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg text-center">
                <div className="bg-primary-green w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Job Guarantee</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Hybrid Learning</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Business Support</h3>
                <p className="text-gray-300">
              ...
              <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Lifetime Network</h3>
                <p className="text-gray-300">
        ...
        {activeTab === 'curriculum' && (
          <div className="space-y-16">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Comprehensive 8-Month Curriculum</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {modules.map((module, index) => (
                <div key={index} className="bg-gray-900/50 border border-gray-700 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                  <div className="p-8">
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-primary-green font-medium">{module.duration}</p>
                      </div>
                    </div>
            ...
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 border border-gray-700 p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Practical Training Components</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold text-white mb-4">Hands-On Experience</h4>
                ...
                <div>
                  <h4 className="text-xl font-semibold text-white mb-4">Assessment Methods</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center text-gray-300">
                      <CheckCircle className="h-5 w-5 text-primary-green mr-3" />
        ...
        {activeTab === 'specializations' && (
          <div className="space-y-16">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Choose Your Specializations</h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {specializations.map((spec, index) => (
                <div key={index} className="bg-gray-900/50 border border-gray-700 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                  ...
                  />
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-white mb-3">{spec.name}</h3>
            ...
            <div className="bg-gradient-to-r from-gray-800 to-gray-900 border border-primary-green text-white p-8 rounded-xl text-center">
        ...
        {activeTab === 'pricing' && (
          <div className="space-y-16">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Investment in Your Future</h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              ...
              {pricingTiers.map((tier) => (
                <div
                  ...
                  className={`rounded-xl shadow-lg overflow-hidden transition-all duration-300 border ${
                    tier.popular ? 'ring-4 ring-primary-green transform scale-105 border-primary-green' : 'border-gray-700'
                  } ${selectedTier === tier.id ? 'bg-primary-green/10' : 'bg-gray-900/50'}`}
                >
                  {tier.popular && (
                    <div className="bg-primary-green text-black text-center py-2 font-semibold">
                      ⭐ Most Popular
                    </div>
                  )}
                  <div className="p-8">
                    ...
                    <div className="flex items-baseline mb-4">
                      <span className="text-4xl font-bold text-primary-green">₹{tier.price}</span>
                      <span className="text-gray-300 ml-2">/ {tier.duration}</span>
                    </div>
                    <ul className="space-y-3 mb-8">
                      {tier.features.map((feature, index) => (
                        <li key={index} className="flex items-start">
                          <CheckCircle className="h-5 w-5 text-primary-green mr-3 mt-0.5 flex-shrink-0" />
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-full font-semibold transition-all duration-200 ${
                        selectedTier === tier.id
                          ...
                          : 'border-2 border-primary-green text-primary-green hover:bg-primary-green hover:text-black'
                      }`}
                    >
            ...
            <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Payment Options & Benefits</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold text-white mb-4">Flexible Payment Plans</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center text-gray-300">
                ...
                <div>
                  <h4 className="text-xl font-semibold text-white mb-4">Scholarship Opportunities</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center text-gray-300">
                      <CheckCircle className="h-5 w-5 text-accent-green mr-3" />
        ...
        {activeTab === 'careers' && (
          <div className="space-y-16">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Launch Your Fitness Career</h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {careerBenefits.map((career, index) => (
                <div key={index} className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg">
                  <h3 className="text-xl font-bold text-white mb-3">{career.role}</h3>
                  <div className="flex items-center text-primary-green font-semibold mb-2">
                    <IndianRupee className="h-5 w-5 mr-1" />
                    {career.salary}
                  </div>
                  <p className="text-gray-300">{career.growth}</p>
                </div>
              ))}
            </div>

            <div className="bg-gradient-to-r from-gray-800 to-gray-900 border border-primary-green text-white p-8 rounded-xl">
              <h3 className="text-2xl font-bold mb-6 text-center">Career Support Services</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  <Users className="h-12 w-12 mx-auto mb-4 text-primary-green" />
                ...
                <div className="text-center">
                  <BookOpen className="h-12 w-12 mx-auto mb-4 text-primary-green" />
                ...
                <div className="text-center">
                  <Award className="h-12 w-12 mx-auto mb-4 text-primary-green" />
            ...
            <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Success Stories</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="bg-primary-green w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-black font-bold text-xl">95%</span>
                  </div>
                  <h4 className="text-lg font-semibold text-white">Job Placement Rate</h4>
                  <p className="text-gray-300">Within 3 months of graduation</p>
                </div>
                <div className="text-center">
                  <div className="bg-primary-green w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-black font-bold text-xl">40%</span>
                  </div>
                  <h4 className="text-lg font-semibold text-white">Salary Increase</h4>
                  <p className="text-gray-300">Average increase for career switchers</p>
                </div>
                <div className="text-center">
                  <div className="bg-primary-green w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-black font-bold text-xl">25+</span>
                  </div>
                  <h4 className="text-lg font-semibold text-white">Partner Gyms</h4>
                  <p className="text-gray-300">Guaranteed interview opportunities</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#15171C]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-gray-900/50 border border-gray-700 p-8 rounded-xl shadow-lg mb-8">
            <h3 className="text-2xl font-bold text-white mb-6">Next Batch Starts</h3>
            <div className="text-6xl font-bold text-primary-green mb-2">15</div>
            <div className="text-xl text-gray-300 mb-4">Days Remaining</div>
            <div className="bg-gray-800 border border-primary-green p-4 rounded-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a
              href="/contact"
              className="bg-primary-green text-black px-8 py-4 rounded-full font-semibold text-lg hover:bg-accent-green transform hover:scale-105 transition-all duration-200"
            >
              Apply Now
            </a>
            <button className="border-2 border-primary-green text-primary-green px-8 py-4 rounded-full font-semibold text-lg hover:bg-primary-green hover:text-black transition-all duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="flex items-center">
              <Phone className="h-6 w-6 text-primary-green mr-3" />
              <div>
            ...
            <div className="flex items-center">
              <Mail className="h-6 w-6 text-primary-green mr-3" />
              <div>
                <p className="font-medium text-white">Email</p>
                <p className="text-gray-300">certification@hfz.com</p>
              </div>
            </div>
            <div className="flex items-center">
              <MapPin className="h-6 w-6 text-primary-green mr-3" />
              <div>
                <p className="font-medium text-white">Visit Us</p>
                <p className="text-gray-300">HFZ Training Center</p>
              </div>
            </div>
          </div>
        </div>
